...
static const char col_gray1[]       = "#@GRAY_1@";
static const char col_gray2[]       = "#@GRAY_2@";
static const char col_gray3[]       = "#@GRAY_3@";
static const char col_gray4[]       = "#@GRAY_4@";
static const char col_acc1[]        = "#@ACCENT1@";
static const char col_acc2[]        = "#@ACCENT2@";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2  },
	[SchemeSel]  = { col_gray4, col_acc1, col_acc2 },
};

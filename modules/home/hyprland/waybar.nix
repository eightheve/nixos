    ...
    programs.waybar = {
      ...
      style = ''
        *{
          ...
          font-weight: bold;
          font-size: 14px;
          ${lib.optionalString config.colorScheme.enable "color: #${config.colorScheme.colors.shade5};"}
        }
        ...
        window {
          ${lib.optionalString config.colorScheme.enable "background-color: #${config.colorScheme.colors.shade0};"}
          border-radius: 0;
          ${lib.optionalString config.colorScheme.enable "border-bottom: 2px solid #${config.colorScheme.colors.shade1};"}
        }
        ...
        #pulseaudio-slider trough {
          ${lib.optionalString config.colorScheme.enable "background-color: #${config.colorScheme.colors.shade2};"}
        }
        #pulseaudio-slider highlight {
          ${lib.optionalString config.colorScheme.enable "background-color: #${config.colorScheme.colors.shade4};"}
        }
